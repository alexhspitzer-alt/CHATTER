...
- Rotating state-assigned hot words using tuned packs: culvert, latch, threshold, cinder, spigot, plus acorn/cobblestone/wick/awning when those uploaded packs are present
